                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => CategoryPage(
                                  category:
                                      CategoryFrame(name: "Destinasi", id: 1),
                                ),
                              ),
                            );
                          },
                          child: const SizedBox(
                            ...
                            child: Card(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Icon(Icons.directions_car, color: bl1),
                                  Text("Destinasi",
                                      style: TextStyle(color: bl1)),
                                ],
                              ),
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => CategoryPage(
                                  category:
                                      CategoryFrame(name: "Kuliner", id: 2),
                                ),
                              ),
                            );
                          },
                          child: const SizedBox(
                            ...
                            child: Card(
                              ...
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Icon(Icons.food_bank_outlined, color: bl1),
                                  Text("Kuliner", style: TextStyle(color: bl1)),
                                ],
                              ),
                            ),
                          ),
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => CategoryPage(
                                  category:
                                      CategoryFrame(name: "Belanja", id: 3),
                                ),
                              ),
                            );
                          },
                          child: const SizedBox(
                            ...
                            child: Card(
                              ...
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Icon(Icons.card_travel, color: bl1),
                                  Text("Belanja", style: TextStyle(color: bl1)),
                                ],
                              ),
                            ),
                          ),
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => CategoryPage(
                                  category: CategoryFrame(name: "Hotel", id: 4),
                                ),
                              ),
                            );
                          },
                          child: const SizedBox(
                            ...
                            child: Card(
                              ...
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Icon(Icons.hotel_class_outlined, color: bl1),
                                  Text("Hotel", style: TextStyle(color: bl1)),
                                ],
                              ),
                            ),
                          ),
                                              ...
                                              return ListView.builder(
                                                ...
                                                padding:
                                                    const EdgeInsets.symmetric(
                                                        vertical: 10),
                                                itemBuilder: (context, index) {
                                                  final BookmarkModel tourist =
                                                      BookmarkModel(
                                                    id: tourists[index]['id'],
                                                    name: tourists[index]
                                                        ['name'],
                                                    description: tourists[index]
                                                        ['description'],
